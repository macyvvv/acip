...
- Only call the selected platform's official analytics/insights API (`platform/system/scripts/analytics/providers.py`) — scraping is prohibited outright as a ToS/business risk.
