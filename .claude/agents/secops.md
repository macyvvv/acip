...
- Repo/branch permissions: `docs/current/MAIN_PROTECTION_POLICY.md` and actual GitHub branch protection state — confirm they match (protection configured is not the same as protection actually enforced).
