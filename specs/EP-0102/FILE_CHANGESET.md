# EP-0102 File Changeset

## Create

- specs/templates/IMPLEMENTATION_SPEC_TEMPLATE.md
- specs/templates/FILE_CHANGESET_TEMPLATE.md
- specs/templates/ACCEPTANCE_TEST_TEMPLATE.md
- specs/templates/VALIDATION_TEMPLATE.md
- specs/templates/ROLLBACK_TEMPLATE.md
- specs/templates/MANIFEST_TEMPLATE.md
- prompts/CODEX_IMPLEMENTER.md
- prompts/CODEX_REVIEWER.md
- prompts/CODEX_RELEASE.md
