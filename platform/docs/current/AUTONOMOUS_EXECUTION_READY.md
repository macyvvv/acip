...
`docs/current/BUSINESS_AGENT_AUTOMATION_READINESS.md` -- describes the
actual execution-approval flow in production today (Levels 0-3a/3c),
built on `system/core/agent_execution_approval.py::evaluate_business_
agent_scope_approval()` and `system/scripts/agent/run_approved_autonomous_
