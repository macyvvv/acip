...
- Greenfield: 2
- Dormant: 0
- Drifted (active but expected path missing): ['kabukicho_survival_map', 'somia']

## Businesses
- `kabukicho_survival_map` (active): Kabukicho Survival Map
  - content_root: businesses/kabukicho_survival_map/app (exists=false)
  - product_code_path: businesses/kabukicho_survival_map/app (exists=false)
...
- `somia` (active): Somia
  - content_root: businesses/somia/content (exists=false)
  - product_code_path: platform/system/scripts/somia (exists=false)
...
- `text_syndicate` (greenfield): Text Syndicate
  - content_root: platform/system/runtime/business_agents/text_syndicate (exists=false)
  - product_code_path: None (exists=false)
  - tracking_issue_numbers: []
