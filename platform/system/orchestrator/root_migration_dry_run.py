...
class RootMigrationDryRun:
    ...
    def run(self) -> RootMigrationDryRunResult:
        ...
        contract = TargetLayoutContract(root_allowlist=("README.md", "AGENTS.md", "platform/docs/", "platform/packs/", "queue/", "platform/system/runtime/", "platform/system/scripts/", "platform/specs/", "platform/system/orchestrator/", "platform/system/tests/", "platform/contracts/"), migration_policy='dry-run only until approved')
