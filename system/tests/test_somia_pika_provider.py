    ...
    def fake_urlopen(request, timeout=None):  # noqa: ANN001
        ...
        if url == "https://queue.fal.run/fal-ai/flux/dev":
            return _json_response({
                "request_id": "kf-1",
                "status_url": "https://queue.fal.run/fal-ai/flux/dev/requests/kf-1/status",
                "response_url": "https://queue.fal.run/fal-ai/flux/dev/requests/kf-1",
            })
        if url == "https://queue.fal.run/fal-ai/flux/dev/requests/kf-1/status":
            return _json_response({"status": "COMPLETED"})
        if url == "https://queue.fal.run/fal-ai/flux/dev/requests/kf-1":
