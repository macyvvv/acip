...
plumbing in `platform/system/platform/scripts/somia/fal_client.py`.
...
`platform/system/platform/scripts/somia/render_content.py` + the provider adapters currently
...
Provider registry (`platform/system/platform/scripts/somia/providers.py`, vendor-agnostic
via `fal_client.py`):
